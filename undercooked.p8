...
function init_choppables()
 ...
 dirty_plate.chop_no=plate
end

function init_cookables()
 pan_burger_raw.cookable=true
 pan_burger_raw.cook_no=pan_burger_cooked--next object
...
function init_plateables()
	hamburger.plateable = true
	hamburger_double.plateable = true
	hamburger_cheeze.plateable = true
end
...
function rec_make(o_top,o_bot)
 ...
 if(obj_out==nil) return out--nothing crafted
...
function new_pobj(obj,x,y)
 ...
 pobj.draw=function(this)
  if (this.plated) then
    obj.draw(plate, this.x, this.y-2)
  end
 ...
 pobj.update=function(this)
  ...
  if(this.obj.cookable)then
   ...
   if(mget(qx+lvl.x,qy+lvl.y)==35 and
    ...
    this.cooking=true
    --stop()
   elseif(mget(qx+lvl.x,qy+lvl.y)==35) then
...
function new_player(pn,x,y)
 ...
 p.pickup=function(this)
  ...
  if    (m==9)then
   this.inv=new_pobj(bun,0,0)
  elseif(m==11)then
   this.inv=new_pobj(steak,0,0)
  elseif(m==13)then
   this.inv=new_pobj(cheeze,0,0)
  elseif(m==45)then
  	this.inv=new_pobj(salad,0,0)
  end
 ...
 p.drop=function(this)
  ...
  --trash can
  if(m==37)then
   if(this.inv.obj.tool)then
    this.inv=new_pobj(pan,0,0)
    shake+=0.04
    return
   else
    this.inv=nil
  ...
  while(i<=count(pobj_arr))do
   if(pobj_arr[i].x==this:nx() and pobj_arr[i].y==this:ny())then
    occupied=true
    if(pobj_arr[i].obj==plate)then
      if this.inv and this.inv.obj.plateable then
        pobj_arr[i] = this.inv
        pobj_arr[i].plated = true
        pobj_arr[i].x = this:nx()
        pobj_arr[i].y = this:ny()
        this.inv=nil
        shake+=0.04
        return
      end
    elseif(this.inv.obj==plate)then
      if pobj_arr[i].obj.plateable then
        pobj_arr[i].plated = true
        this.inv=nil
        shake+=0.04
        return
      ...
      local result=rec_make(this.inv.obj,pobj_arr[i].obj)
      if result.made_recipe then
        if result.o_top then
          this.inv.obj=result.o_top
        else
          this.inv=nil
        end
  ...
  -- there was nothing here so we add the object
  if not occupied then
    this.inv.x = this:nx()
    this.inv.y = this:ny()
    add(pobj_arr,this.inv)
    this.inv=nil
    shake+=0.04
  end
 end
 ...
 p.startchop=function(this)
  ...
  local qy=flr(this.ny(this)/8)
  local m=mget(qx+lvl.x,qy+lvl.y)
  if m==1 then---chopping board
    shake+=0.06
    local po=get_pobj(this:nx(),this:ny())
    if (this.inv!=nil or po==nil) then return end
    if(po.obj.chop_no==nil)then return end
    this.ischopping=true
  elseif m==3 then--dishwasher
    shake+=0.06
    local po=get_pobj(this:nx(),this:ny())
    if (this.inv!=nil or po==nil)return
    if (po.obj!=dirty_plate)return
    this.ischopping=true
  end
 end
 ...
 p.invdraw=function(this)
  ...
  local o=this.inv.obj
  local plated=this.inv.plated
  local x=this.x
  local y=this.y
...
function update_game()
 ...
 if plates_to_deliver>0 and t % 600 == 0 then
  plates_to_deliver-=1
  add_dirty_plate()
 end
end
...
function draw_game()
 ...
 for i=1,#pobj_arr do
  ...
  elseif(o.cooking and m==35)then
...
function init_game(lvl_n)
 ...
 score=0
 plates_to_deliver=0
 --TODO make algo to spawn player
 --in valid spot
...
function add_plates(count)
  for i=0,16 do
    for j=0,16 do
      if (mget(i+lvl.x,j+lvl.y)==5) then
        for _=1,count do
          add(pobj_arr,new_pobj(plate,i*8,j*8))
        end
        return
      end
    end
...
function add_dirty_plate()
  for i=0,16 do
    for j=0,16 do
      if (mget(i+lvl.x,j+lvl.y)==43) then
        add(pobj_arr,new_pobj(dirty_plate,i*8,j*8))
        return
      end
    end
  end
...

...

...

...

...

...

...

...

...


__gff__

...

...
__sfx__

...

__music__
01 10111244
03 10111344
03 14111544

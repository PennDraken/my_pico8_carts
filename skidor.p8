	...
	for i=0,15 do
		for j=0,15 do
			if cy+j*8>0 then--todo check ouofbounds
				...
				elseif fget(mget(mpos.x,mpos.y),0) then
					--small shadow
...
function green_particles(x,y)
 ...
 for i=1,10 do
 	...
 	local dx=rnd(1)*speed*rnd({-1,1})
 	local dy=sqrt(speed^2-dx^2)*rnd({-1,1})
  add_new_dust(
...

...

...

...
__gff__


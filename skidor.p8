...
function draw_player()
	...
	set_p_pal()
	if p_inshadow and not p.jumping then
		--set_dark_pal()
	end
	if p.crash then
		spr(79,p.x,p.y-cy)
...
function move_player()
 ...
 if abs(p.speed) > 0 then
 	p.speed = p.speed * max(p_friction*sin(p.angle),0.991)
 	--p.speed += 0.1
 else
  p.speed = 0
 end
 if p.speed < p.maxspeed then
  p.speed = p.speed + p_acc*sin(p.angle)
 else
  --travelling too fast
...
10101010101010101010101010101010c2d2c2d2621010101010021010101062101010101010101010101010101010102030203081e5b5101002101010108191
...
10101010101010101010101010101010c3d3c3d36310101010021010c2d21063101010101010101010101010101010102131213110a6b6809010021010108090
...
101010101010101010101010c2d2c3d312c2d2e01010101010101010101010108090809082821010101010101010101010101010100210101010102030203020
...
10101010101010101010c2d2c3d3c2d2d2c3d3e11010101010101010101010108191819183838210101010101010101010101010100210101010102131213121
...
10101010101010101010c3d31010c3d3d312c2d210101010101010101010101080904050c2d28310101010101010101010101010100210101010101080908090
...
10101010101010101092c2d26292c2d2c2d2c3d310101010101010101010101081914151c3d37282101010101010101010101010100210101010101081918191
...
1010101010101010c2d2c3d36310c3d3c3d3c2d2101010101010101010101010607012117312118310a210101010101010101010100210101010405060708090
...
1010101010101010c3d3c2d2c2d2c2d2c2d2c3d3101010101010101010101010617111117311100182a310101010101010101010100210101010415161718191
...
10a3101010101010c3d3c2d2c2d2c2d2d2f1c3d31010101010101010101010101111111011111010821010101010101010101010100210101010101010101010

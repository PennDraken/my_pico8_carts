function init_mouse()
    ...
    mouse.update = function(this)
        ...
        if this.left_click and (stat(34) & 0b001)!=1 and not this.is_moving and this.object_selected and this.left_held_time < 15 then
    ...
    mouse.draw = function(this)
        ...
        if this.object_hovered and this.object_hovered.hover_text then
            ...
            print(reverse_case(this.object_hovered.hover_text), x+1, y, 7)
        end
    end
    return mouse
end
